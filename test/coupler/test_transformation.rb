...
class Coupler::TestResource < Test::Unit::TestCase
  #def setup
  ...
  def test_sequel_model
    assert_equal Sequel::Model, Coupler::Transformation.superclass
    assert_equal :transformations, Coupler::Transformation.table_name
  end

  def test_many_to_one_resources
    assert_respond_to Coupler::Transformation.new, :resource
  end

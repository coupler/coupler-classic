...
class Coupler::Extensions::TestResources < Test::Unit::TestCase
  def setup
  ...
  def test_successfully_creating_resource
    ...
    resource = Coupler::Resource[:name => attribs[:name], :project_id => @project.id]
    assert resource
